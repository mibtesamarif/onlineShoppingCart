            ...
            <div class="card text-center card-product">
              <div class="card-product__img">
                ...
                <ul class="card-product__imgOverlay">
                  ...
                  <li><button><i class="ti-shopping-"></i></button></li>
			...
			?>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="adminpanel/img/<?php echo $cat['image']?>" alt="IMG-BANNER">

						<a href="product.php?id=<?php echo $cat['id']?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $product["c_id"]?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="adminpanel/img/<?php echo $product['image']?>" alt="IMG-PRODUCT">
